...
const ProductView = (props) => {
  ...
  const [previewImg, setPreviewImage] = useState(
    props.product ? getImageSrc(product.image1) : ''
  );
  ...
  useEffect(() => {
    setPreviewImage(props.product ? getImageSrc(product.image1) : '');
    setQuantity(1);
    setColor(undefined);
    setSize(undefined);
  }, [props.product]);
    ...
    <div className="product">
      <div className="product-images">
        <div className="product-images-list">
          ...
          >
            <img
              src={props.product ? getImageSrc(product.image1) : ''}
              alt=""
            />
          </div>
          <div
            className="product-images-list-item"
            onClick={() =>
              setPreviewImage(props.product ? getImageSrc(product.image2) : '')
            }
          >
            <img
              src={props.product ? getImageSrc(product.image2) : ''}
              alt=""
            />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <div className="product-info-item">
          <span className="product-info-item-price">
            {product.sale ? (
              <div>
                {numberWithCommas(
                  Number(product.price - (product.price * product.sale) / 100)
                )}{' '}
                đ
        ...
        <div className="product-info-item">
          <div className="product-info-item-title">Màu sắc</div>
          <div className="product-info-item-list">
            {product.color.map((item, index) => (
              <div
                key={index}
                className={`product-info-item-list-item ${
                  color === item ? 'active' : ''
                }`}
        ...
        <div className="product-info-item">
          <div className="product-info-item-title">Kích cỡ</div>
          <div className="product-info-item-list">
        ...
        <div className="product-info-item">
          <div className="product-info-item-title">Số lượng</div>
          <div className="product-info-item-quantity">
            <div
              className="product-info-item-quantity-btn"
